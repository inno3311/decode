...
@Autonomous(name="BlueBack3_C_Corn", group="Linear OpMode")
public class BlueBack3_C_Corn extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        if (TuningOpModes.DRIVE_CLASS.equals(MecanumDrive.class))
        {
            ...
            TrajectoryActionBuilder yellow_drop = drive.actionBuilder(beginPose)
                ...
                .splineTo(new Vector2d(36,-60),Math.toRadians(270),new TranslationalVelConstraint(20)) //1st set pickup
                ...
                .strafeTo(new Vector2d(60, -70)) //hit again
                  .strafeTo(new Vector2d(55, -50)) //back up
                  .afterTime(0.1,actionsBackpack.intakeBall(1))
                  .strafeTo(new Vector2d(70, -70)) //hit again
                .waitSeconds(2)
                ; //do not remove ;
